...
/*--------------------------------------------------------------------------------SMTP*/
  function sendEmail() {
    Email.send({
        ...
        To : '',
        From : '',
        Subject : "FormSubmission: " + document.getElementById("subject").value,
        Body : "Name: " + document.getElementById("name").value + "<br>" + "Email: " + document.getElementById("email").value + "<br><br>" + document.getElementById("text").value
    }).then(
